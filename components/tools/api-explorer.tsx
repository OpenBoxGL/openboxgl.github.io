...
const ENDPOINTS: EndpointDef[] = [
  ...
  {
    id: "screenscraper-status",
    method: "GET",
    path: "/api/v2/screenscraper/status",
    title: "ScreenScraper Status (v1.8.0)",
    description: "Whether ScreenScraper credentials are configured and the disk-cache entry count.",
    mockResponse: { configured: true, cache_entries: 42 },
  },
  {
    id: "screenscraper-search",
    method: "GET",
    path: "/api/v2/screenscraper/search?q=super+mario+world&platform=SNES",
    title: "ScreenScraper Search (v1.8.0)",
    description: "Title search against ScreenScraper; exact matches first.",
    mockResponse: {
      results: [{ scraper_id: "12345", name: "Super Mario World", platform: "SNES" }],
    },
  },
  {
    id: "screenscraper-test",
    method: "POST",
    path: "/api/v2/screenscraper/test",
    title: "ScreenScraper Credential Test (v1.8.0)",
    description: "Verifies the configured SCREENSCRAPER_USER/PASSWORD credentials.",
    mockResponse: { ok: true, user: { id: "u", level: 1 } },
  },
  {
    id: "screenscraper-match",
    method: "POST",
    path: "/api/v2/screenscraper/match",
    title: "ScreenScraper Hash Match (v1.8.0)",
    description: "Queues a durable batch hash-match job (batch <= 100, cancellable).",
    mockResponse: { state: "queued", job_id: "screenscraper-match" },
  },
  {
    id: "screenscraper-apply",
    method: "POST",
    path: "/api/v2/screenscraper/apply",
    title: "ScreenScraper Apply (v1.8.0)",
    description: "Queues a durable job that applies matched metadata and downloads media outside the state lock.",
    mockResponse: { state: "queued", job_id: "screenscraper-apply" },
  },
  {
    id: "library-export",
    method: "POST",
    path: "/api/v2/library/export",
    title: "Library Export (v1.8.0)",
    description: "Queues a durable JSON/CSV export job with all/platform/playlist scope.",
    mockResponse: { state: "queued", job_id: "library-export" },
  },
  {
    id: "library-export-list",
    method: "GET",
    path: "/api/v2/library/export/exports",
    title: "Library Export List (v1.8.0)",
    description: "Lists generated export files (newest 10 kept).",
    mockResponse: {
