...
export const requiredRoutes = [
  ...
  '/reference/configuration/', '/reference/cli/', '/reference/command-tokens/', '/reference/data-and-recovery/', '/reference/how-it-works/', '/reference/api/', '/reference/plugins/', '/reference/parity/',
