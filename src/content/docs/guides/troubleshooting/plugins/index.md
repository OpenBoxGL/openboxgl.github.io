...
description: Safe checks for plugins problems.
---

Start with the safest check for plugins problems. Confirm the current data directory and inspect the diagnostic log before changing state.
