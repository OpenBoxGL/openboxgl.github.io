...
description: Safe checks for imports problems.
---

Start with the safest check for imports problems. Confirm the current data directory and inspect the diagnostic log before changing state.
