...
description: Safe checks for launching problems.
---

Start with the safest check for launching problems. Confirm the current data directory and inspect the diagnostic log before changing state.
