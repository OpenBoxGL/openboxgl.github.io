...
description: Safe checks for startup and browser problems.
---

Start with the safest check for startup and browser problems. Confirm the current data directory and inspect the diagnostic log before changing state.
