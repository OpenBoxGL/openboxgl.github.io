...
description: Safe checks for diagnostic logs problems.
---

Start with the safest check for diagnostic logs problems. Confirm the current data directory and inspect the diagnostic log before changing state.
