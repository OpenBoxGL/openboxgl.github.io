...
description: Safe checks for integration credentials problems.
---

Start with the safest check for integration credentials problems. Confirm the current data directory and inspect the diagnostic log before changing state.
