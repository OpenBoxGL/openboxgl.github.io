...
description: Safe checks for state recovery problems.
---

Start with the safest check for state recovery problems. Confirm the current data directory and inspect the diagnostic log before changing state.
