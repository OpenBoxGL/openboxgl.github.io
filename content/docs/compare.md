...
| Topic | OpenBoxGL 1.9.0 | LaunchBox on Linux |
| --- | --- | --- |
...
| LaunchBox Premium cloud library | Replaced by OpenBox's own mounted-folder sync plus local backups (no LaunchBox account involved) |
| LaunchBox online theme storefront | Replaced by local CSS theme import and open folder workflow |

## How to verify

- Check the current release tag at [Releases](https://github.com/vindeckyy/OpenBoxGL/releases/latest), currently v1.9.0.
