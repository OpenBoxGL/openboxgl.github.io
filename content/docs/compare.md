...
| Topic | OpenBoxGL 1.4.0 | LaunchBox on Linux |
| --- | --- | --- |
...
- Check the current release tag at [Releases](https://github.com/vindeckyy/OpenBoxGL/releases/latest), currently v1.4.0.
