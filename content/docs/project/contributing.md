...
```bash
./run_all_tests.sh  # 100 files, 0 failures (see `scripts/check_tests.py` for 72.0% total + 54.0% web_app.py + 80% changed-line + 85% new-module floors; CI enforces a stricter 95% changed-line floor)
