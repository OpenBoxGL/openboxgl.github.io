...
- **Additive v2 API (`/api/v2/*`)**: Modern workflows introduced in v1.7.0 through v1.12.0:
...
See [API 1.11 additions](/reference/api/one-eleven/) and [API 1.12 additions](/reference/api/one-twelve/) for request bodies, response examples, optional-tool caveats, and stale-plan handling.
