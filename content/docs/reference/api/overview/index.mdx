...
- **Additive v2 API (`/api/v2/*`)**: Modern workflows introduced in v1.7.0 through v1.9.0:
  ...
  - **LaunchBox Migration** (v1.9.0): `POST /api/v2/import/launchbox/preview`, `POST /api/v2/import/launchbox/apply`
  - **Library Sync + Manual Entries** (v1.9.0): `POST /api/v2/library/sync/publish`, `POST /api/v2/library/sync/pull`, `POST /api/v2/library/manual-entry`
