...
The check uses `secrets.compare_digest`, and unauthenticated requests to any protected route, known or unknown, return `403 {"error":"Unauthorized","code":"UNAUTHORIZED","request_id":"…"}`.
...
- **Additive v2 API (`/api/v2/*`)**: Modern workflows introduced in v1.7.0 through v1.10.0:
