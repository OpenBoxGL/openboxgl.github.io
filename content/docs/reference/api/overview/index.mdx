...
- **Additive v2 API (`/api/v2/*`)**: Modern workflows introduced in v1.7.0 and v1.7.1:
  - **Setup Center**: `POST /api/v2/setup/preview`, `GET /api/v2/setup/preview/status`, `GET /api/v2/setup/preview/items`, `POST /api/v2/setup/preview/decision`, `POST /api/v2/setup/commit`
  - **Launch Doctor**: `POST /api/v2/launch/preflight`, `POST /api/v2/launch/preflight/batch`
  - **Emulator Registry**: `GET /api/v2/emulators/registry`
  - **Metadata Matches**: `GET /api/v2/metadata/matches/batches`, `GET /api/v2/metadata/matches/items`, `POST /api/v2/metadata/matches/apply`, `POST /api/v2/metadata/matches/reject`
  - **Durable Operations**: `GET /api/v2/jobs`, `GET /api/v2/jobs/events`, `POST /api/v2/jobs/{id}/cancel`, `POST /api/v2/jobs/{id}/retry`, `POST /api/v2/jobs/{id}/resume`
