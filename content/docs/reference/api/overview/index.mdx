...
See [API 1.11 additions](/reference/api/one-eleven/), [API 1.12 additions](/reference/api/one-twelve/), and [API 1.14 additions](/reference/api/one-fourteen/) for request bodies, response examples, optional-tool caveats, and stale-plan handling.
