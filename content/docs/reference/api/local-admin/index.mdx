...
```json
{
 ...
 "latest": "1.9.0",
 "available": false,
 "last_checked": 1756848000,
 "notes": "...",
 "appimage": "https://github.com/vindeckyy/OpenBoxGL/releases/download/.../OpenBox-x86_64.AppImage",
 "checksum": "sha256:...",
 "checksum_url": "...",
 "sig": "https://github.com/vindeckyy/OpenBoxGL/releases/download/.../OpenBox-x86_64.AppImage.sig",
 "sig_url": "...",
...
```json
{
  "report": "{\"version\": \"1.9.0\", \"python\": \"3.12.3\", \"platform\": \"Linux-...\", \"data_dir\": \"~/.local/share/openbox-game-launcher\", \"games_count\": 42, \"running_count\": 0, \"settings_summary\": { ... }}"
}
```
...
Returns native host capabilities detected by the backend when running inside the native WebKitGTK wrapper or desktop environment.
