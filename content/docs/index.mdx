...
[**Install OpenBoxGL 1.12.1**](/install/) [**Read the quick start**](/getting-started/) [**Read the release notes**](/changelog/)
...
OpenBoxGL targets Linux desktops, laptops, Steam Deck systems, and handheld PCs on x86_64 and aarch64. Source installs require Python 3.10 or newer; the AppImage bundles its own Python runtime. The current requirements and package paths are listed in [Installation](/install/).
