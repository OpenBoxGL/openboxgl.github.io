...
<ProductShot src="/openbox-screenshot.png" alt="The OpenBox Web UI: filter rail on the left, cover grid in the center, and the selected game's detail pane on the right." caption="The Web UI: filter rail, cover grid, and game detail pane in one workspace." />
