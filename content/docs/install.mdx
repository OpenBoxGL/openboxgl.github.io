...
<InstallOptionCard slot="flatpak">
 ...
 - The manifest (the `flatpak` module) uses the GNOME / Flatpak 25.08 runtime and grants `--filesystem=home`, so Steam, Heroic, Lutris, and ROM folders under your home directory are readable.
