...
| Windows: `running scripts is disabled on this system` | Run the script with `powershell -ExecutionPolicy Bypass -File .\install.ps1 -Tag v1.13.0`, or set your user execution policy. See [Windows](/windows/). |
