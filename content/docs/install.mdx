...
The fastest path is the [one-liner install](#one-liner-install): `curl ... | bash` downloads the latest AppImage, verifies its checksum, and installs it to `~/.local/bin`.
