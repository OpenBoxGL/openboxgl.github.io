...
<InstallOptionCard slot="flatpak">
 ...
 Download `OpenBox-x86_64.flatpak` from the [release page](https://github.com/vindeckyy/OpenBoxGL/releases/tag/v1.14.0) for the bundle install.
...
| Windows: `running scripts is disabled on this system` | Run the script with `powershell -ExecutionPolicy Bypass -File .\install.ps1 -Tag v1.14.0`, or set your user execution policy. See [Windows](/windows/). |
