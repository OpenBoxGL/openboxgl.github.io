...
Only the latest release on the `master` branch is maintained. The older rows are historical release lines and do not promise backports; upgrade to 1.12.x to receive fixes.
